...
export const GoogleSignIn = memo(function GoogleSignIn({ navigation }: { navigation: StackNavigationProp }) {
  useEffect(() => {
    GoogleSignin.configure({
      ...
      webClientId:
        '281361953262-45v058vqni3j617ra33sionbc86op114.apps.googleusercontent.com', // client ID of type WEB for your server (needed to verify user ID and offline access)
